...
[![PkgGoDev](https://pkg.go.dev/badge/utilware/bun/driver/pgdriver)](https://pkg.go.dev/utilware/bun/driver/pgdriver)
...
```shell
go get utilware/bun/driver/pgdriver
```

And then create a `sql.DB` using it:

```go
import _ "utilware/bun/driver/pgdriver"
