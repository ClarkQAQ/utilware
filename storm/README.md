...
[![GoDoc](https://godoc.org/utilware/dep/github.com/asdine/storm?status.svg)](https://godoc.org/utilware/dep/github.com/asdine/storm)

Storm is a simple and powerful toolkit for [BoltDB](https://utilware/dep/github.com/coreos/bbolt). Basically, Storm provides indexes, a wide range of methods to store and fetch data, an advanced query system, and much more.

In addition to the examples below, see also the [examples in the GoDoc](https://godoc.org/utilware/dep/github.com/asdine/storm#pkg-examples).

_For extended queries and support for [Badger](https://utilware/dep/github.com/dgraph-io/badger), see also [Genji](https://utilware/dep/github.com/asdine/genji)_
...
```bash
GO111MODULE=on go get -u utilware/storm
```

## Import Storm

```go
import "utilware/storm"
```
...
`Select` takes any number of [`Matcher`](https://godoc.org/utilware/dep/github.com/asdine/storm/q#Matcher) from the [`q`](https://godoc.org/utilware/dep/github.com/asdine/storm/q) package.
...
You can find the complete list in the [documentation](https://godoc.org/utilware/dep/github.com/asdine/storm/q#Matcher).

`Select` takes any number of matchers and wraps them into a `q.And()` so it's not necessary to specify it. It returns a [`Query`](https://godoc.org/utilware/dep/github.com/asdine/storm#Query) type.
...
See the [documentation](https://godoc.org/utilware/dep/github.com/asdine/storm#Query) for a complete list of methods.
...
To store the data in BoltDB, Storm marshals it in JSON by default. If you wish to change this behavior you can pass a codec that implements [`codec.MarshalUnmarshaler`](https://godoc.org/utilware/dep/github.com/asdine/storm/codec#MarshalUnmarshaler) via the [`storm.Codec`](https://godoc.org/utilware/dep/github.com/asdine/storm#Codec) option:
...
You can easily implement your own `MarshalUnmarshaler`, but Storm comes with built-in support for [JSON](https://godoc.org/utilware/dep/github.com/asdine/storm/codec/json) (default), [GOB](https://godoc.org/utilware/dep/github.com/asdine/storm/codec/gob),  [Sereal](https://godoc.org/utilware/dep/github.com/asdine/storm/codec/sereal), [Protocol Buffers](https://godoc.org/utilware/dep/github.com/asdine/storm/codec/protobuf) and [MessagePack](https://godoc.org/utilware/dep/github.com/asdine/storm/codec/msgpack).
...
import (
  "utilware/storm"
  "utilware/storm/codec/gob"
  "utilware/storm/codec/json"
  "utilware/storm/codec/sereal"
  "utilware/storm/codec/protobuf"
  "utilware/storm/codec/msgpack"
)
...
**Tip**: Adding Storm tags to generated Protobuf files can be tricky. A good solution is to use [this tool](https://utilware/dep/github.com/favadi/protoc-go-inject-tag) to inject the tags during the compilation.
...
Batch mode can be enabled to speed up concurrent writes (see [Batch read-write transactions](https://utilware/dep/github.com/coreos/bbolt#batch-read-write-transactions))
...
You can find other useful methods in the [documentation](https://godoc.org/utilware/dep/github.com/asdine/storm#KeyValueStore).
...
- [Asdine El Hrychy](https://utilware/dep/github.com/asdine)
- [Bjørn Erik Pedersen](https://utilware/dep/github.com/bep)
