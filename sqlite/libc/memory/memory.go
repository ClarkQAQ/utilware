...
// Build status
//
// available at https://modern-c.appspot.com/-/builder/?importpath=utilware/sqlite%2fmemory
//
// Changelog
//
...
//
//  jnml@3900x:~/src/utilware/sqlite/memory$ date ; go version ; go test -run @ -bench . -benchmem |& tee log
//  Fri Nov 20 17:23:04 CET 2020
//  go version go1.15.5 linux/amd64
//  goos: linux
//  goarch: amd64
//  pkg: utilware/sqlite/memory
...
//  PASS
//  ok  	utilware/sqlite/memory	70.528s
//  jnml@3900x:~/src/utilware/sqlite/memory$
//
// Intel® Core™ i5-4670 CPU @ 3.40GHz × 4
//
//  ==== jnml@4670:~/src/utilware/sqlite/memory> date ; go version ; go test -run @ -bench . -benchmem |& tee log
...
//  PASS
//  ok  	utilware/sqlite/memory	73.859s
//  //
// Intel® Xeon(R) CPU E5-1650 v2 @ 3.50GHz × 12
//
//  ==== jnml@e5-1650:~/src/utilware/sqlite/memory> date ; go version ; go test -run @ -bench . -benchmem
...
//  PASS
//  ok  	utilware/sqlite/memory	80.896s
package memory // import "utilware/sqlite/memory"
