...
package gen // import "utilware/dep/x/text/internal/gen"
...
const header = `// Code generated by running "go generate" in utilware/dep/x/text. DO NOT EDIT.
...
func localReadmeFile() (string, error) {
	p, err := build.Import("utilware/dep/x/text", "", build.FindOnly)
	if err != nil {
...
const readmeTxt = `Generated by utilware/dep/x/text/internal/gen. DO NOT EDIT.

This directory contains downloaded files used to generate the various tables
in the utilware/dep/x/text subrepo.
