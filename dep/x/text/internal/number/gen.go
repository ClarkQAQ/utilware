...
import (
	...
	"utilware/dep/x/text/internal/gen"
	"utilware/dep/x/text/internal/language"
	"utilware/dep/x/text/internal/language/compact"
	"utilware/dep/x/text/internal/number"
	"utilware/dep/x/text/internal/stringset"
	"utilware/dep/x/text/unicode/cldr"
)
...
func main() {
	...
	fmt.Fprintln(w, `import "utilware/dep/x/text/internal/stringset"`)
