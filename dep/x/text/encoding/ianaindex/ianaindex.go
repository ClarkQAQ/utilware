...
import (
	...
	"utilware/dep/x/text/encoding/charmap"
	"utilware/dep/x/text/encoding/internal/identifier"
	"utilware/dep/x/text/encoding/japanese"
	"utilware/dep/x/text/encoding/korean"
	"utilware/dep/x/text/encoding/simplifiedchinese"
	"utilware/dep/x/text/encoding/traditionalchinese"
	"utilware/dep/x/text/encoding/unicode"
)
