...
import (
	...
	"utilware/dep/x/text/feature/plural"
	"utilware/dep/x/text/internal"
	"utilware/dep/x/text/internal/catmsg"
...
import (
	"utilware/dep/x/text/language"
	"utilware/dep/x/text/message"
	"utilware/dep/x/text/message/catalog"
)
