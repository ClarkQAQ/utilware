...
import (
	...
	fmtparser "utilware/dep/x/text/internal/format"
...
func (x *extracter) seedEndpoints() error {
	pkgInfo := x.iprog.Package("utilware/dep/x/text/message")
	if pkgInfo == nil {
		return errors.New("pipeline: utilware/dep/x/text/message is not imported")
	}
