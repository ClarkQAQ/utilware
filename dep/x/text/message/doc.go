...
//
// 1. Install gotext
//    go get -u utilware/dep/x/text/cmd/gotext
//    gotext -help
//
...
// see also package utilware/dep/x/text/message/catalog can be used to implement
...
// utilware/dep/x/text/feature and utilware/dep/x/text/message/catalog for more
// information.
//
package message
