...
import (
	...
	"utilware/dep/x/text/internal/format"
...
// It implements "utilware/dep/x/text/internal/format".State.
type printer struct {
	Printer
...
// Language implements "utilware/dep/x/text/internal/format".State.
