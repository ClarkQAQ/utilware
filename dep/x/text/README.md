...
[![Go Reference](https://pkg.go.dev/badge/utilware/dep/x/text.svg)](https://pkg.go.dev/utilware/dep/x/text)
...
The easiest way to install is to run `go get -u utilware/dep/x/text`. You can
also manually git clone the repository to `$GOPATH/src/utilware/dep/x/text`.
