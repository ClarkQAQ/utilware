...
import (
	...
	"utilware/dep/x/image/font"
	"utilware/dep/x/image/font/gofont/gobold"
	"utilware/dep/x/image/font/gofont/gomono"
	"utilware/dep/x/image/font/gofont/goregular"
	"utilware/dep/x/image/math/fixed"
)
...
func testTrueType(t *testing.T, f *Font) {
	...
	// versions may add more glyphs, but https://blog.ccms/go-fonts says
