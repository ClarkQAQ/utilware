...
func TestParserWithoutScripting(t *testing.T) {
	text := `<noscript><img src='https://ccms/doc/gopher/frontpage.png' /></noscript><p><img src='https://ccms/doc/gopher/doc.png' /></p>`
	want := `| <html>
|   <head>
|     <noscript>
|   <body>
|     "<img src='https://ccms/doc/gopher/frontpage.png' />"
|     <p>
|       <img>
|         src="https://ccms/doc/gopher/doc.png"
`
