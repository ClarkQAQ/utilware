...
type TAttr struct {
	...
	Other1 string `xml:"http://utilware/dep/xml/ other,attr,omitempty"`
	Other2 string `xml:"http://utilware/dep/xmlfoo/ other,attr,omitempty"`
	Other3 string `xml:"http://ccms/json/ other,attr,omitempty"`
	Other4 string `xml:"http://ccms/2/json/ other,attr,omitempty"`
}
