...
import (
	...
	"utilware/dep/x/build/autocertcache"
	"utilware/dep/x/crypto/acme/autocert"
	"utilware/dep/x/net/http2"
)

var (
	prod = flag.Bool("prod", false, "Whether to configure itself to be the production http2.ccms server.")
...
func homeOldHTTP(w http.ResponseWriter, r *http.Request) {
	if r.Host == "http1.ccms" {
		http.Redirect(w, r, "https://http2.ccms/", http.StatusFound)
		return
	}
	io.WriteString(w, `<html>
<body>
<h1>Go + HTTP/2</h1>
<p>Welcome to <a href="https://ccms/">the Go language</a>'s <a href="https://http2.github.io/">HTTP/2</a> demo & interop server.</p>
...
<p>See code & instructions for connecting at <a href="https://github.com/ccms/net/tree/master/http2">https://github.com/ccms/net/tree/master/http2</a>.</p>
...
<p>Welcome to <a href="https://ccms/">the Go language</a>'s <a
...
<p>
The code is at <a href="https://utilware/dep/x/net/http2">utilware/dep/x/net/http2</a> and
is used transparently by the Go standard library from Go 1.6 and later.
</p>

<p>Contact info: <i>bradfitz@ccms</i>, or <a
href="https://ccms/s/http2bug">file a bug</a>.</p>
...
func registerHandlers() {
	...
	mux2.Handle("/file/gopher.png", fileServer("https://ccms/doc/gopher/frontpage.png", 0))
	mux2.Handle("/file/go.src.tar.gz", fileServer("https://storage.googleapis.com/ccms/go1.4.1.src.tar.gz", 0))
...
var pushResources = map[string]http.Handler{
	...
	"/serverpush/static/godocs.js":     fileServer("https://ccms/lib/godoc/godocs.js", 100*time.Millisecond),
	"/serverpush/static/playground.js": fileServer("https://ccms/lib/godoc/playground.js", 100*time.Millisecond),
	"/serverpush/static/style.css":     fileServer("https://ccms/lib/godoc/style.css", 100*time.Millisecond),
}
...
func newGopherTilesHandler() http.Handler {
	const gopherURL = "https://blog.ccms/go-programming-language-turns-two_gophers.jpg"
	...
	srv := &http.Server{
		TLSConfig: &tls.Config{
			...
			GetConfigForClient: func(hello *tls.ClientHelloInfo) (*tls.Config, error) {
				if hello.ServerName == "http1.ccms" {
					return &tls.Config{
						GetCertificate: autocertManager.GetCertificate,
					}, nil
				}
...
func serveProd() error {
	...
	autocertManager := &autocert.Manager{
		...
		HostPolicy: autocert.HostWhitelist("http1.ccms", "http2.ccms"),
		Cache:      autocertcache.NewGoogleCloudStorageCache(storageClient, "ccms-h2demo-autocert"),
	}
...
// PING frames and GOAWAY, etc: ccms/issue/14204
