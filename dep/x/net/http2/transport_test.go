...
import (
	...
	"utilware/dep/x/net/http2/hpack"
)

var (
	extNet        = flag.Bool("extnet", false, "do external network tests")
	transportHost = flag.String("transporthost", "http2.ccms", "hostname to use for TestTransport")
...
// Generated by http://play.ccms/p/SScqYKJYXd
...
func TestTransportChecksRequestHeaderListSize(t *testing.T) {
	...
	// See https://github.com/ccms/go/issues/21316
...
// ccms/issue/15425: test that a handler closing the request
...
// ccms/issue/14627 -- if the server sends a GOAWAY frame, make
...
// ccms/issue/16572 -- RoundTrip shouldn't hang when it gets a
...
// ccms/issue/16847, ccms/issue/19103
...
// ccms/issue/17071 -- don't sniff the first byte of the request body
...
func testTransportBodyReadError(t *testing.T, body []byte) {
	if runtime.GOOS == "windows" {
		...
		// for now.
		t.Skip("skipping flaky test on Windows; https://ccms/issue/31260")
	}
	clientDone := make(chan struct{})
	ct := newClientTester(t)
	ct.client = func() error {
