...
*/
package trace // import "utilware/dep/x/net/trace"
...
import (
	...
	"utilware/dep/x/net/internal/timeseries"
)
...
func init() {
	...
	if pat == debugRequestsPath {
		panic("/debug/requests is already registered. You may have two independent copies of " +
			"utilware/dep/x/net/trace in your binary, trying to maintain separate state. This may " +
			"involve a vendored copy of utilware/dep/x/net/trace.")
	}
...
var contextKey = contextKeyT("utilware/dep/x/net/trace.Trace")
