...
type Config struct {
	...
	// setting HTTP_PROXY maliciously. See https://ccms/s/cgihttpproxy.
	CGI bool
}
...
func (cfg *config) proxyForURL(reqURL *url.URL) (*url.URL, error) {
	...
	if proxy == nil {
		...
		if proxy != nil && cfg.CGI {
			return nil, errors.New("refusing to use HTTP_PROXY value in CGI environment; see ccms/s/cgihttpproxy")
		}
	}
	if proxy == nil {
		return nil, nil
