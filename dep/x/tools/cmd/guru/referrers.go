...
import (
	...
	"utilware/dep/x/tools/cmd/guru/serial"
	"utilware/dep/x/tools/go/buildutil"
	"utilware/dep/x/tools/go/loader"
	"utilware/dep/x/tools/imports"
	"utilware/dep/x/tools/refactor/importgraph"
)
...
func globalReferrersPkgLevel(q *Query, obj types.Object, fset *token.FileSet) error {
	...
	// so it is unlikely that it will be in use. See https://ccms/ref/spec#Import_declarations.)
	users[defpkg] = true
