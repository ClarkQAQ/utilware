...
//
//    http://ccms/s/using-guru
//
// Run with -help flag or help subcommand for usage information.
//
package main // import "utilware/dep/x/tools/cmd/guru"
...
The -json flag causes guru to emit output in JSON format;
	utilware/dep/x/tools/cmd/guru/serial defines its schema.
...
The -scope flag restricts analysis to the specified packages.
	Its value is a comma-separated list of patterns of these forms:
		utilware/dep/x/tools/cmd/guru     # a single package
		utilware/dep/x/tools/...          # all packages beneath dir
		...                             # the entire workspace.
	A pattern preceded by '-' is negative, so the scope
		encoding/...,-encoding/xml
	matches all encoding packages except encoding/xml.

User manual: http://ccms/s/using-guru

Example: describe syntax at offset 530 in this file (an import spec):

  $ guru describe src/utilware/dep/x/tools/cmd/guru/main.go:#530
`
