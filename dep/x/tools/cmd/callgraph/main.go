...
package main // import "utilware/dep/x/tools/cmd/callgraph"
...
import (
	...
	"utilware/dep/x/tools/go/callgraph"
	"utilware/dep/x/tools/go/callgraph/cha"
	"utilware/dep/x/tools/go/callgraph/rta"
	"utilware/dep/x/tools/go/callgraph/static"
	"utilware/dep/x/tools/go/packages"
	"utilware/dep/x/tools/go/pointer"
	"utilware/dep/x/tools/go/ssa"
	"utilware/dep/x/tools/go/ssa/ssautil"
)
...
-format    Specifies the format in which each call graph edge is displayed.
           One of:
            ...
            digraph     output suitable for input to
                        utilware/dep/x/tools/cmd/digraph.
...
Examples:
  ...
  Show all functions directly called by the callgraph tool's main function:
    ...
    callgraph -format=digraph utilware/dep/x/tools/cmd/callgraph |
      digraph succs utilware/dep/x/tools/cmd/callgraph.main
`
