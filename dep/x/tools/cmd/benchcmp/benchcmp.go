...
import (
	...
	"utilware/dep/x/tools/benchmark/parse"
)
...
func main() {
	fmt.Fprintf(os.Stderr, "benchcmp is deprecated in favor of benchstat: https://pkg.go.dev/utilware/dep/x/perf/cmd/benchstat\n")
	flag.Usage = func() {
