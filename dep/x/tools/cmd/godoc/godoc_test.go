...
func TestTypeAnalysis(t *testing.T) {
	...
	// TODO(ccms/issue/34473): Add support for type, pointer
...
func testTypeAnalysis(t *testing.T, x packagestest.Exporter, bin string) {
	...
	// TODO(ccms/issue/34473): This test uses import paths without a dot in first
...
`,
	...
	// TODO(ccms/issue/34473): This test optimization may not be viable in module mode.
