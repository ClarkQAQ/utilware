...
adding missing ones and removing unreferenced ones.
     ...
     $ go get utilware/dep/x/tools/cmd/goimports
...
For vim, set "gofmt_command" to "goimports":
    https://ccms/change/39c724dd7f252
    https://ccms/wiki/IDEsAndTextEditorPlugins
    etc
...
File bugs or feature requests at:
    ...
    https://ccms/issues/new?title=x/tools/cmd/goimports:+

Happy hacking!

*/
package main // import "utilware/dep/x/tools/cmd/goimports"
