...
import (
	...
	"utilware/dep/x/tools/playground/socket"
	"utilware/dep/x/tools/present"

	// This will register handlers at /compile and /share that will proxy to the
	// respective endpoints at play.ccms. This allows the frontend to call
...
func playable(c present.Code) bool {
	...
	// Restrict playable files to only Go source files when using play.ccms,
