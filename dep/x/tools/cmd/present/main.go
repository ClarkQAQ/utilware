...
const basePkg = "utilware/dep/x/tools/cmd/present"
...
var (
	...
	usePlayground = flag.Bool("use_playground", false, "run code snippets using play.ccms; if false, run them locally and deliver results by WebSocket transport")
