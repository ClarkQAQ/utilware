...
which can be slide presentations as in utilware/dep/x/tools/cmd/present
or articles as in utilware/dep/x/blog (the Go blog).
...
*/
package present // import "utilware/dep/x/tools/present"
