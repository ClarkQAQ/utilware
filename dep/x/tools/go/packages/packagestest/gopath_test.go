...
func TestGOPATHExport(t *testing.T) {
	...
	checkFiles(t, exported, []fileTest{
		{"ccms/fake1", "a.go", "fake1/src/ccms/fake1/a.go", checkLink("testdata/a.go")},
		{"ccms/fake1", "b.go", "fake1/src/ccms/fake1/b.go", checkContent("package fake1")},
		{"ccms/fake2", "other/a.go", "fake2/src/ccms/fake2/other/a.go", checkContent("package fake2")},
		{"ccms/fake2/v2", "other/a.go", "fake2_v2/src/ccms/fake2/v2/other/a.go", checkContent("package fake2")},
	})
}
