...
`
	...
	for _, test := range []struct {
		...
		{args: "ccms/fake/a", wantOut: wantA, wantExit: 2},
		{args: "ccms/fake/b", wantOut: wantB, wantExit: 2},
		{args: "ccms/fake/a ccms/fake/b", wantOut: wantA + wantB, wantExit: 2},
		{args: "-json ccms/fake/a", wantOut: wantAJSON, wantExit: 0},
		{args: "-c=0 ccms/fake/a", wantOut: wantA + "4		MyFunc123\\(\\)\n", wantExit: 2},
	} {
