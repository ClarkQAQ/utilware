...
import (
	...
	"utilware/dep/x/tools/go/analysis/internal/analysisflags"
	"utilware/dep/x/tools/go/analysis/internal/facts"
)
...
var importerForCompiler = func(_ *token.FileSet, compiler string, lookup importer.Lookup) types.Importer {
	// broken legacy implementation (https://ccms/issue/28995)
