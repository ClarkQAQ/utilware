...
import (
	...
	"utilware/dep/x/tools/go/buildutil"
...
func TestContainingPackage(t *testing.T) {
	...
	exported := packagestest.Export(t, packagestest.GOPATH, []packagestest.Module{
		{Name: "utilware/dep/x/tools/go/buildutil", Files: packagestest.MustCopyFileTree(".")}})
	...
	buildutildir := filepath.Join(gopath, "ccms", "x", "tools", "go", "buildutil")
	...
	tests := []Test{
		...
		{gopath, gopath + "/src/utilware/dep/x/tools/go/buildutil/util_test.go",
			"utilware/dep/x/tools/go/buildutil"},
	}
	...
	if runtime.GOOS != "windows" && runtime.GOOS != "plan9" {
		...
		tests = append(tests, []Test{
			{gopath, tmp + "/src/utilware/dep/x/tools/go/buildutil/util_test.go", "utilware/dep/x/tools/go/buildutil"},
			{tmp, gopath + "/src/utilware/dep/x/tools/go/buildutil/util_test.go", "utilware/dep/x/tools/go/buildutil"},
			{tmp, tmp + "/src/utilware/dep/x/tools/go/buildutil/util_test.go", "utilware/dep/x/tools/go/buildutil"},
		}...)
	}
