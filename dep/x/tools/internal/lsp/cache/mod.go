...
func extractModParseErrors(ctx context.Context, uri span.URI, m *protocol.ColumnMapper, parseErr error, content []byte) (source.Error, error) {
	...
	if len(matches) < 3 {
		log.Error(ctx, "could not parse utilware/dep/x/mod error message", parseErr)
...
// 	go 1.11
//
// 	require utilware/dep/x/mod v0.1.1-0.20191105210325-c90efee705ee
// After:
// 	module t
//
// 	go 1.11
...
// 	go 1.11
//
// 	require utilware/dep/x/mod v0.1.1-0.20191105210325-c90efee705ee // indirect
