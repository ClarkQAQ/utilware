...
import (
	...
	"utilware/dep/x/tools/internal/lsp/browser"
...
func (b *bug) Run(ctx context.Context, args ...string) error {
	...
	if !browser.Open("https://github.com/ccms/go/issues/new?title=" + url.QueryEscape(title) + "&body=" + url.QueryEscape(body)) {
		fmt.Print("Please file a new issue at ccms/issue/new using this template:\n\n")
		fmt.Print(body)
	}
	return nil
}
