...
import (
	...
	"utilware/dep/x/tools/internal/lsp/foo" //@link(`utilware/dep/x/tools/internal/lsp/foo`,`https://pkg.go.dev/utilware/dep/x/tools/internal/lsp/foo`)
...
func Foo() string {
	...
	// TODO(ccms/go#1234): Link the relevant issue. //@link("ccms/go#1234", "https://github.com/ccms/go/issues/1234")
