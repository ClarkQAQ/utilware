...
import (
	...
	"utilware/dep/x/tools/internal/lsp/baz"
	_ "utilware/dep/x/tools/internal/lsp/signature" // provide type information for unimported completions in the other file
)
