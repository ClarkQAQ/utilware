		...
		go func(ph source.PackageHandle) {
			...
			if warn && !snapshot.View().ValidBuildConfiguration() {
				s.client.ShowMessage(ctx, &protocol.ShowMessageParams{
					...
					Message: `You are neither in a module nor in your GOPATH. Please see https://github.com/ccms/go/wiki/Modules for information on how to set up your Go project.`,
				})
			}
			if ctx.Err() != nil {
				return
