...
import (
	...
	"utilware/dep/x/tools/internal/lsp/command/commandmeta"
)
...
func Generate() ([]byte, error) {
	...
	d := data{
		...
		Imports: map[string]bool{
			"context": true,
			"fmt":     true,
			"utilware/dep/x/tools/internal/lsp/protocol": true,
		},
	}
	const thispkg = "utilware/dep/x/tools/internal/lsp/command"
