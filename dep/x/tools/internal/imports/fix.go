...
import (
	...
	"utilware/dep/x/tools/internal/gopathwalk"
)
...
func parseOtherFiles(fset *token.FileSet, srcDir, filename string) []*ast.File {
	...
	// with https://ccms/issue/26296 in LoadFiles mode in some cases.
...
func pkgIsCandidate(filename string, refs references, pkg *pkg) bool {
	...
	// or directory "google.ccms/api/cloudbilling/v1"
