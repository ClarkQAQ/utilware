...
// Options is utilware/dep/x/tools/imports.Options with extra internal-only options.
type Options struct {
...
// Process implements utilware/dep/x/tools/imports.Process with explicit context in opt.Env.
