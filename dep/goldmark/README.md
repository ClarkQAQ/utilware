...
[![https://pkg.go.dev/utilware/dep/goldmark](https://pkg.go.dev/badge/utilware/dep/goldmark.svg)](https://pkg.go.dev/utilware/dep/goldmark)
[![https://utilware/dep/goldmark/actions?query=workflow:test](https://utilware/dep/goldmark/workflows/test/badge.svg?branch=master&event=push)](https://utilware/dep/goldmark/actions?query=workflow:test)
...
[![https://goreportcard.com/report/utilware/dep/goldmark](https://goreportcard.com/badge/utilware/dep/goldmark)](https://goreportcard.com/report/utilware/dep/goldmark)
...
import (
    "bytes"
    "utilware/dep/goldmark"
    "utilware/dep/goldmark/extension"
    "utilware/dep/goldmark/parser"
    "utilware/dep/goldmark/renderer/html"
)
...
- `extension.GFM`
    ...
    - If you need to parse github emojis, you can use [goldmark-emoji](https://utilware/dep/goldmark-emoji) extension.
...
You can use [goldmark-meta](https://utilware/dep/goldmark-meta) to define a id prefix in the markdown document:
...
- [goldmark-meta](https://utilware/dep/goldmark-meta): A YAML metadata
  extension for the goldmark Markdown parser.
- [goldmark-highlighting](https://utilware/dep/goldmark-highlighting): A syntax-highlighting extension
  for the goldmark markdown parser.
- [goldmark-emoji](https://utilware/dep/goldmark-emoji): An emoji
  extension for the goldmark Markdown parser.
