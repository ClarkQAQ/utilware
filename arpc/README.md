...
[8]: https://utilware/arpc/actions?query=workflow%3build-linux
[9]: https://goreportcard.com/badge/utilware/arpc
[10]: https://goreportcard.com/report/utilware/arpc
[11]: https://codecov.io/gh/lesismal/arpc/branch/master/graph/badge.svg
[12]: https://codecov.io/gh/lesismal/arpc
[13]: https://godoc.org/utilware/arpc?status.svg
[14]: https://godoc.org/utilware/arpc
...
```sh
$ go get -u utilware/arpc
```

2. Import in your code:

```go
import "utilware/arpc"
```


## Quick Start
 
- start a [server](https://utilware/arpc/blob/master/examples/rpc/server/server.go)
...
- start a [client](https://utilware/arpc/blob/master/examples/rpc/client/client.go)
...
See [router middleware](https://utilware/arpc/tree/master/extension/middleware/router), it's easy to implement middlewares yourself

```golang
import "utilware/arpc/extension/middleware/router"
...
```golang
import "utilware/arpc/extension/middleware/coder/gzip"
...
- for more details:	[**server**](https://utilware/arpc/blob/master/examples/broadcast/server/server.go) [**client**](https://utilware/arpc/blob/master/examples/broadcast/client/client.go)
...
- See [arpc.js](https://utilware/arpc/blob/master/extension/jsclient/arpc.js)

## Web Chat Examples

- See [webchat](https://utilware/arpc/tree/master/examples/webchat)
...
- start a server
```golang
import "utilware/arpc/extension/pubsub"
...
- See [examples](https://utilware/arpc/tree/master/examples)
